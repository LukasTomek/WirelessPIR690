...
r0x102E	res	1
r0x102F	res	1
_dec_to_ascii_number_1_30	res	5
...
_00134_DS_:
	BTFSS	STATUS,0
	GOTO	_00106_DS_
;;genSkipc:3257: created from rifx:0x7fff6d9f7b70
...
_00155_DS_:
;	.line	245; "main.c"	if (i > 8 && bitfield.Hint && t > 7000){
	MOVLW	0x09
	BANKSEL	r0x104A
	SUBWF	r0x104A,W
	BTFSS	STATUS,0
...
_00258_DS_:
	...
	GOTO	_00160_DS_
;;genSkipc:3257: created from rifx:0x7fff6d9f7b70
;	.line	249; "main.c"	dec_to_ascii(w);
	BANKSEL	_w
	MOVF	_w,W
	MOVWF	STK00
	MOVF	(_w + 1),W
...
;	.line	250; "main.c"	SP_send(tab);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	251; "main.c"	dec_to_ascii(t);
	BANKSEL	_t
	MOVF	_t,W
	MOVWF	STK00
	MOVF	(_t + 1),W
...
;	.line	262; "main.c"	w1 = w;
	...
	MOVWF	(_w1 + 1)
_00167_DS_:
;	.line	273; "main.c"	int_error_cnt = 0;
...
_dec_to_ascii:
; 2 exit points
;	.line	306; "main.c"	void dec_to_ascii(unsigned short dec)
	BANKSEL	r0x1042
	MOVWF	r0x1042
	MOVF	STK00,W
	MOVWF	r0x1043
;	.line	311; "main.c"	for (i=0 ; dec!=0; i++)
	CLRF	r0x1044
_00277_DS_:
	BANKSEL	r0x1043
	MOVF	r0x1043,W
	...
	BTFSC	STATUS,2
	GOTO	_00286_DS_
;	.line	313; "main.c"	number[i]=(dec % 10);
	MOVF	r0x1044,W
...
_00273_DS_:
	...
	BTFSC	STATUS,2
	GOTO	_00279_DS_
;	.line	319; "main.c"	circBufPush(number[i]);	// Add a character to the output buffer
	MOVF	r0x1043,W
	ADDLW	(_dec_to_ascii_number_1_30 + 0)
	MOVWF	r0x1042
	MOVLW	high (_dec_to_ascii_number_1_30 + 0)
...
_circBufPush:
; 2 exit points
;	.line	277; "main.c"	int circBufPush(uint8_t data){
	BANKSEL	r0x1030
	MOVWF	r0x1030
;	.line	278; "main.c"	uint8_t next = buf_head + 1;
	BANKSEL	_buf_head
	INCF	_buf_head,W
	BANKSEL	r0x1031
	MOVWF	r0x1031
;;unsigned compare: left < lit(0x10=16), size=1
;	.line	279; "main.c"	if (next >= BUF_SIZE)
	MOVLW	0x10
;	.line	280; "main.c"	next = 0;
	SUBWF	r0x1031,W
;	.line	283; "main.c"	if (next == buf_tail){
	BTFSC	STATUS,0
	CLRF	r0x1031
	BANKSEL	_buf_tail
	MOVF	_buf_tail,W
	...
	BTFSS	STATUS,2
	GOTO	_00266_DS_
;	.line	284; "main.c"	SP_send_error(buf_err);
	...
	CALL	_SP_send_error
	PAGESEL	$
;	.line	285; "main.c"	return -1;  // quit with an error
	MOVLW	0xff
	MOVWF	STK00
	MOVLW	0xff
	GOTO	_00267_DS_
_00266_DS_:
;	.line	288; "main.c"	buf[buf_head] = data;
	BANKSEL	_buf_head
	MOVF	_buf_head,W
	ADDLW	(_buf + 0)
	BANKSEL	r0x1033
	...
	BANKSEL	INDF
	MOVWF	INDF
;	.line	289; "main.c"	buf_head = next;
	BANKSEL	r0x1031
	MOVF	r0x1031,W
	BANKSEL	_buf_head
	MOVWF	_buf_head
;	.line	290; "main.c"	TXIE = 1;       //Enables the EUSART transmit interrupt
	BANKSEL	_PIE1bits
	BSF	_PIE1bits,4
;	.line	291; "main.c"	return 0;
	MOVLW	0x00
	MOVWF	STK00
	MOVLW	0x00
_00267_DS_:
...
;	  690+  215 =   905 instructions ( 2240 byte)

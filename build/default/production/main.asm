...
_00139_DS_:
	BTFSS	STATUS,0
	GOTO	_00108_DS_
;;genSkipc:3257: created from rifx:0x7fffe31170d0
...
;	.line	239; "main.c"	w1 = w;
	...
	MOVWF	_w1
_00160_DS_:
;	.line	241; "main.c"	CCP1IE = 0;
	BANKSEL	_PIE1bits
	BCF	_PIE1bits,2
;;unsigned compare: left < lit(0x1E=30), size=1
;	.line	242; "main.c"	if(k >= 30){
	MOVLW	0x1e
	BANKSEL	r0x1075
	SUBWF	r0x1075,W
	BTFSS	STATUS,0
	GOTO	_00164_DS_
;;genSkipc:3257: created from rifx:0x7fffe31170d0
;	.line	243; "main.c"	for(j = 0; j < 30; j++){
	CLRF	r0x1077
_00170_DS_:
;	.line	244; "main.c"	uint8_to_ascii_buf(bw[j]);
	BANKSEL	r0x1077
	MOVF	r0x1077,W
	ADDLW	(_bw + 0)
	MOVWF	r0x1078
...
;	.line	245; "main.c"	SP_send(tab);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	246; "main.c"	uint8_to_ascii_buf(bt[j]);
	BANKSEL	r0x1077
	MOVF	r0x1077,W
	ADDLW	(_bt + 0)
	MOVWF	r0x1078
...
;;unsigned compare: left < lit(0x1E=30), size=1
	...
	GOTO	_00170_DS_
;;genSkipc:3257: created from rifx:0x7fffe31170d0
;	.line	249; "main.c"	for(j = 0; j < 6; j++){
	CLRF	r0x1077
_00172_DS_:
;	.line	250; "main.c"	uint8_to_ascii_buf(bwk[j]);
	BANKSEL	r0x1077
	MOVF	r0x1077,W
	ADDLW	(_bwk + 0)
	MOVWF	r0x1078
...
;	.line	251; "main.c"	SP_send(tab);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	252; "main.c"	uint8_to_ascii_buf(bw16[j]);
	BANKSEL	r0x1077
	MOVF	r0x1077,W
	ADDLW	(_bw16 + 0)
	MOVWF	r0x1078
...
;	.line	253; "main.c"	SP_send(tab);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	254; "main.c"	uint8_to_ascii_buf(btk[j]);
	BANKSEL	r0x1077
	MOVF	r0x1077,W
	ADDLW	(_btk + 0)
	MOVWF	r0x1078
...
;	.line	255; "main.c"	SP_send(tab);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	256; "main.c"	uint8_to_ascii_buf(bt16[j]);
	BANKSEL	r0x1077
	MOVF	r0x1077,W
	ADDLW	(_bt16 + 0)
	MOVWF	r0x1078
...
;	.line	262; "main.c"	j = 0;
	CLRF	r0x1076
_00164_DS_:
;	.line	264; "main.c"	CCP1IE = 1;
	BANKSEL	_PIE1bits
	BSF	_PIE1bits,2
;	.line	265; "main.c"	int_error_cnt = 0;
	BANKSEL	_int_error_cnt
	CLRF	_int_error_cnt
	GOTO	_00166_DS_
	RETURN	
...
_circBufPush:
; 2 exit points
;	.line	269; "main.c"	int circBufPush(uint8_t data){
	BANKSEL	r0x106F
	MOVWF	r0x106F
;	.line	270; "main.c"	uint8_t next = buf_head + 1;
	BANKSEL	_buf_head
	INCF	_buf_head,W
	BANKSEL	r0x1070
	MOVWF	r0x1070
;;unsigned compare: left < lit(0x10=16), size=1
;	.line	271; "main.c"	if (next >= BUF_SIZE)
	MOVLW	0x10
;	.line	272; "main.c"	next = 0;
	SUBWF	r0x1070,W
;	.line	275; "main.c"	if (next == buf_tail){
	BTFSC	STATUS,0
	CLRF	r0x1070
	BANKSEL	_buf_tail
	MOVF	_buf_tail,W
	...
	BTFSS	STATUS,2
	GOTO	_00180_DS_
;	.line	276; "main.c"	SP_send(buf_err);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	277; "main.c"	return -1;  // quit with an error
	MOVLW	0xff
	MOVWF	STK00
	MOVLW	0xff
	GOTO	_00181_DS_
_00180_DS_:
;	.line	280; "main.c"	buf[buf_head] = data;
	BANKSEL	_buf_head
	MOVF	_buf_head,W
	ADDLW	(_buf + 0)
	BANKSEL	r0x1072
	...
	BANKSEL	INDF
	MOVWF	INDF
;	.line	281; "main.c"	buf_head = next;
	BANKSEL	r0x1070
	MOVF	r0x1070,W
	BANKSEL	_buf_head
	MOVWF	_buf_head
;	.line	282; "main.c"	TXIE = 1;       //Enables the EUSART transmit interrupt
	BANKSEL	_PIE1bits
	BSF	_PIE1bits,4
...
;	  540+  185 =   725 instructions ( 1820 byte)

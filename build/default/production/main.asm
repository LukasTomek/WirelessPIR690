...
_00139_DS_:
	BTFSS	STATUS,0
	GOTO	_00108_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
...
;	.line	175; "main.c"	delay_ms(10);
	...
	CALL	_delay_ms
	PAGESEL	$
;	.line	176; "main.c"	for(i = 0; i <= 11; i++){
	BANKSEL	r0x1042
	CLRF	r0x1042
;;104	MOVF	r0x1042,W
_00189_DS_:
;	.line	178; "main.c"	result = ADC_read(i); // select chanel AN0 = 0
	BANKSEL	r0x1044
	CLRF	r0x1044
;;103	MOVF	r0x1043,W
	MOVF	r0x1042,W
	...
	MOVF	STK00,W
	MOVWF	r0x1043
;	.line	179; "main.c"	SP_send_buf(stri);
	MOVLW	high (_stri + 0)
	MOVWF	r0x1045
	MOVLW	(_stri + 0)
	MOVWF	r0x1046
	...
	PAGESEL	$
;;102	MOVF	r0x1042,W
;	.line	180; "main.c"	dec_to_ascii_buf(i);
	BANKSEL	r0x1045
	CLRF	r0x1045
;;101	MOVF	r0x1046,W
	MOVF	r0x1042,W
	...
	PAGESEL	$
;	.line	181; "main.c"	SP_send_buf(space);
	MOVLW	high (_space + 0)
	BANKSEL	r0x1045
	MOVWF	r0x1045
	MOVLW	(_space + 0)
	...
	CALL	_SP_send_buf
	PAGESEL	$
;	.line	182; "main.c"	dec_to_ascii_buf(result);
	BANKSEL	r0x1043
	MOVF	r0x1043,W
	MOVWF	STK00
	MOVF	r0x1044,W
	...
	CALL	_dec_to_ascii_buf
	PAGESEL	$
;	.line	183; "main.c"	SP_send_buf(enter);
	MOVLW	high (_enter + 0)
	BANKSEL	r0x1045
	MOVWF	r0x1045
	MOVLW	(_enter + 0)
...
_00300_DS_:
	...
	GOTO	_00148_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	186; "main.c"	SetAddress[i] = BIT1;
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_SetAddress + 0)
	MOVWF	r0x1046
...
_00148_DS_:
;	.line	187; "main.c"	else if(result < 300)
	MOVLW	0x01
	BANKSEL	r0x1044
	SUBWF	r0x1044,W
	BTFSS	STATUS,2
...
_00301_DS_:
	...
	GOTO	_00145_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	188; "main.c"	SetAddress[i] = BIT0;
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_SetAddress + 0)
	MOVWF	r0x1043
	...
	GOTO	_00190_DS_
_00145_DS_:
;	.line	190; "main.c"	SetAddress[i] = BITF;
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_SetAddress + 0)
	MOVWF	r0x1043
...
;;unsigned compare: left >= lit(0xC=12), size=1
	...
	GOTO	_00189_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	193; "main.c"	for(i = 0; i <= 11; i++){
	CLRF	r0x1042
_00191_DS_:
;	.line	194; "main.c"	SP_send_buf(stri);
	MOVLW	high (_stri + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_stri + 0)
	...
	PAGESEL	$
;;100	MOVF	r0x1042,W
;	.line	195; "main.c"	dec_to_ascii_buf(i);
	BANKSEL	r0x1044
	CLRF	r0x1044
;;99	MOVF	r0x1043,W
	MOVF	r0x1042,W
	...
	CALL	_dec_to_ascii_buf
	PAGESEL	$
;	.line	196; "main.c"	SP_send_buf(space);
	MOVLW	high (_space + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_space + 0)
	...
	CALL	_SP_send_buf
	PAGESEL	$
;	.line	197; "main.c"	dec_to_ascii_buf(SetAddress[i]);
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_SetAddress + 0)
	MOVWF	r0x1043
	...
	CALL	_dec_to_ascii_buf
	PAGESEL	$
;	.line	198; "main.c"	SP_send_buf(enter);
	MOVLW	high (_enter + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_enter + 0)
...
;;genSkipc:3257: created from rifx:0x7fff7f40e400
_00187_DS_:
;	.line	210; "main.c"	if (bitfield.Capture){
	BANKSEL	_bitfield
	BTFSS	_bitfield,0
	GOTO	_00183_DS_
;	.line	211; "main.c"	bitfield.Capture = FALSE;
	BCF	_bitfield,0
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit(0x759=1881), size=2
;	.line	212; "main.c"	if (t > MIN_T && t < MAX_T && t1 > MIN_T && t1 < MAX_T){
	MOVLW	0x07
	BANKSEL	_t
	SUBWF	(_t + 1),W
	BTFSS	STATUS,2
...
;	.line	213; "main.c"	if (w > MIN_W1 && w < MAX_W1 && w1 > MIN_W1 && w1 < MAX_W1){
	MOVLW	0x05
	BANKSEL	_w
	SUBWF	(_w + 1),W
	BTFSS	STATUS,2
...
_00311_DS_:
	...
	GOTO	_00153_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	215; "main.c"	RecAddress[i] = BIT1;
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_RecAddress + 0)
	MOVWF	r0x1043
...
_00153_DS_:
;	.line	220; "main.c"	if (w > MIN_W0 && w < MAX_W0 && w1 > MIN_W0 && w1 < MAX_W0){
	MOVLW	0x01
	BANKSEL	_w
	SUBWF	(_w + 1),W
	BTFSS	STATUS,2
...
_00315_DS_:
	...
	GOTO	_00158_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	222; "main.c"	RecAddress[i] = BIT0;
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_RecAddress + 0)
	MOVWF	r0x1043
...
;;unsigned compare: left >= lit(0x17D=381), size=2
_00158_DS_:
;	.line	227; "main.c"	if (w1 > MIN_W0 && w1 < MAX_W0 && w > MIN_W1 && w < MAX_W1){
	MOVLW	0x01
	BANKSEL	_w1
	SUBWF	(_w1 + 1),W
	BTFSS	STATUS,2
...
_00319_DS_:
	...
	GOTO	_00168_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	229; "main.c"	RecAddress[i] = BITF;
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	ADDLW	(_RecAddress + 0)
	MOVWF	r0x1043
...
_00168_DS_:
;	.line	235; "main.c"	if (t > MIN_TS && t < MAX_TS && w > MIN_W0 && w < MAX_W0){
	MOVLW	0x3a
	BANKSEL	_t
	SUBWF	(_t + 1),W
	BTFSS	STATUS,2
...
_00323_DS_:
	...
	GOTO	_00178_DS_
;;genSkipc:3257: created from rifx:0x7fff7f40e400
;	.line	236; "main.c"	SP_send_buf(sync);
	MOVLW	high (_sync + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_sync + 0)
...
;	.line	238; "main.c"	w = 0;
	...
	CLRF	_w
	CLRF	(_w + 1)
;	.line	239; "main.c"	temp = 1;
	MOVLW	0x01
	BANKSEL	r0x1043
	MOVWF	r0x1043
;	.line	240; "main.c"	i--;
	DECF	r0x1042,F
;	.line	241; "main.c"	GIE = 0; //not tested
	BANKSEL	_INTCONbits
	BCF	_INTCONbits,7
;	.line	242; "main.c"	for(j = 11; j != 0; j--){
	BANKSEL	r0x1042
	MOVF	r0x1042,W
	MOVWF	r0x1044
	MOVLW	0x0b
	MOVWF	r0x1046
_00193_DS_:
;	.line	244; "main.c"	if (RecAddress[i] != SetAddress[j]){
	BANKSEL	r0x1044
	MOVF	r0x1044,W
	ADDLW	(_RecAddress + 0)
	MOVWF	r0x1045
...
;	.line	242; "main.c"	for(j = 11; j != 0; j--){
	...
	MOVF	r0x1044,W
	MOVWF	r0x1042
;	.line	249; "main.c"	GIE = 1;
	BANKSEL	_INTCONbits
	BSF	_INTCONbits,7
;	.line	251; "main.c"	if(temp){
	BANKSEL	r0x1043
	MOVF	r0x1043,W
	BTFSC	STATUS,2
	GOTO	_00178_DS_
;	.line	252; "main.c"	SP_send_buf(light);
	MOVLW	high (_light + 0)
	MOVWF	r0x1044
	MOVLW	(_light + 0)
	MOVWF	r0x1043
	...
	CALL	_SP_send_buf
	PAGESEL	$
;	.line	253; "main.c"	OUT_PIN = 1;
	BANKSEL	_PORTBbits
	BSF	_PORTBbits,6
;	.line	254; "main.c"	TMR0 = 0;	// Enable timer
	CLRF	_TMR0
;	.line	255; "main.c"	T0IE = 1;
	BSF	_INTCONbits,5
_00178_DS_:
;	.line	264; "main.c"	t1 = t;
	BANKSEL	_t
	MOVF	_t,W
	BANKSEL	_t1
	MOVWF	_t1
...
_circBufPush:
; 2 exit points
;	.line	275; "main.c"	int circBufPush(uint8_t data){
	BANKSEL	r0x103D
	MOVWF	r0x103D
;	.line	276; "main.c"	uint8_t next = buf_head + 1;
	BANKSEL	_buf_head
	INCF	_buf_head,W
	BANKSEL	r0x103E
	MOVWF	r0x103E
;;unsigned compare: left < lit(0x10=16), size=1
;	.line	277; "main.c"	if (next >= BUF_SIZE)
	MOVLW	0x10
;	.line	278; "main.c"	next = 0;
	SUBWF	r0x103E,W
;	.line	281; "main.c"	if (next == buf_tail){
	BTFSC	STATUS,0
	CLRF	r0x103E
	BANKSEL	_buf_tail
	MOVF	_buf_tail,W
	...
	BTFSS	STATUS,2
	GOTO	_00332_DS_
;	.line	282; "main.c"	SP_send(buf_err);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	283; "main.c"	return -1;  // quit with an error
	MOVLW	0xff
	MOVWF	STK00
	MOVLW	0xff
	GOTO	_00333_DS_
_00332_DS_:
;	.line	286; "main.c"	buf[buf_head] = data;
	BANKSEL	_buf_head
	MOVF	_buf_head,W
	ADDLW	(_buf + 0)
	BANKSEL	r0x1040
	...
	BANKSEL	INDF
	MOVWF	INDF
;	.line	287; "main.c"	buf_head = next;
	BANKSEL	r0x103E
	MOVF	r0x103E,W
	BANKSEL	_buf_head
	MOVWF	_buf_head
;	.line	288; "main.c"	TXIE = 1;       //Enables the EUSART transmit interrupt
	BANKSEL	_PIE1bits
	BSF	_PIE1bits,4
...
;	  677+  188 =   865 instructions ( 2106 byte)

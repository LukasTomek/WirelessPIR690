...
_00139_DS_:
	BTFSS	STATUS,0
	GOTO	_00108_DS_
;;genSkipc:3257: created from rifx:0x7ffebd7f1c20
...
_00322_DS_:
	...
	GOTO	_00154_DS_
;;genSkipc:3257: created from rifx:0x7ffebd7f1c20
;	.line	213; "main.c"	SP_send_buf(strV1);
	MOVLW	high (_strV1 + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_strV1 + 0)
...
_00326_DS_:
	...
	GOTO	_00159_DS_
;;genSkipc:3257: created from rifx:0x7ffebd7f1c20
;	.line	220; "main.c"	SP_send_buf(strV0);
	MOVLW	high (_strV0 + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_strV0 + 0)
...
_00330_DS_:
	...
	GOTO	_00169_DS_
;;genSkipc:3257: created from rifx:0x7ffebd7f1c20
;	.line	227; "main.c"	SP_send_buf(strVF);
	MOVLW	high (_strVF + 0)
	BANKSEL	r0x1044
	MOVWF	r0x1044
	MOVLW	(_strVF + 0)
...
;	  789+  221 =  1010 instructions ( 2462 byte)

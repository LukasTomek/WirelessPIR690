...
_00139_DS_:
	BTFSS	STATUS,0
	GOTO	_00108_DS_
;;genSkipc:3257: created from rifx:0x7fffe2536480
...
;	.line	225; "main.c"	w1 = w;
	...
	MOVWF	(_w1 + 1)
_00175_DS_:
;	.line	228; "main.c"	int_error_cnt = 0;
	BANKSEL	_int_error_cnt
	CLRF	_int_error_cnt
;;unsigned compare: left < lit(0x13=19), size=1
;	.line	229; "main.c"	if(i >= 19){
	MOVLW	0x13
	BANKSEL	r0x1036
	SUBWF	r0x1036,W
	BTFSS	STATUS,0
...
_circBufPush:
; 2 exit points
;	.line	235; "main.c"	int circBufPush(uint8_t data){
	BANKSEL	r0x1031
	MOVWF	r0x1031
;	.line	236; "main.c"	uint8_t next = buf_head + 1;
	BANKSEL	_buf_head
	INCF	_buf_head,W
	BANKSEL	r0x1032
	MOVWF	r0x1032
;;unsigned compare: left < lit(0x10=16), size=1
;	.line	237; "main.c"	if (next >= BUF_SIZE)
	MOVLW	0x10
;	.line	238; "main.c"	next = 0;
	SUBWF	r0x1032,W
;	.line	241; "main.c"	if (next == buf_tail){
	BTFSC	STATUS,0
	CLRF	r0x1032
	BANKSEL	_buf_tail
	MOVF	_buf_tail,W
	...
	BTFSS	STATUS,2
	GOTO	_00297_DS_
;	.line	242; "main.c"	SP_send(buf_err);
	...
	CALL	_SP_send
	PAGESEL	$
;	.line	243; "main.c"	return -1;  // quit with an error
	MOVLW	0xff
	MOVWF	STK00
	MOVLW	0xff
	GOTO	_00298_DS_
_00297_DS_:
;	.line	246; "main.c"	buf[buf_head] = data;
	BANKSEL	_buf_head
	MOVF	_buf_head,W
	ADDLW	(_buf + 0)
	BANKSEL	r0x1034
	...
	BANKSEL	INDF
	MOVWF	INDF
;	.line	247; "main.c"	buf_head = next;
	BANKSEL	r0x1032
	MOVF	r0x1032,W
	BANKSEL	_buf_head
	MOVWF	_buf_head
;	.line	248; "main.c"	TXIE = 1;       //Enables the EUSART transmit interrupt
	BANKSEL	_PIE1bits
	BSF	_PIE1bits,4
;	.line	249; "main.c"	return 0;
	MOVLW	0x00
	MOVWF	STK00
	MOVLW	0x00
_00298_DS_:
...
;	  542+  147 =   689 instructions ( 1672 byte)
